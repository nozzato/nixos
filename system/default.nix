{ inputs, lib, config, pkgs, ... }: {
  ...
  programs.ssh = {
    knownHosts = {
      ...
      nozbox-pve.publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOXtnbmWJAO1mZ3uYg9LnVOD2IDFrr/c3SX3RxOnnu2s";
      nozbox.publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILtowgPdBeyhV+EkYVE5JkwBFcGL8LLdawNPrIOlVwdr";
